                    ...
                    <div className='grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4'>
                        ...
                        <div>
                            ...
                            <ul className='mt-2 space-y-2'>
                                ...
                                <li>
                                    <a href="/" className='text-gray-500 transition-colors duration-300
                                    hover:text-orange-500'>Eduction</a>
                                </li>
                                <li>
                                    <a href="/" className='text-gray-500 transition-colors duration-300
                    ...
                    <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                        ...
                        <form className='mt-4 flex flex-col md:flex-row'>
                            <input type="email" name='email' id='email'
                                className='flex-grow w-full h-12 px-4 mb-3 transition duration-200 border border-gray-300 
                        ...
                        <p className='mt-4 text-sm text-gray-500'>Lorem ipsum dolor sit amet consectetur adipiscing elit.
                            sunt nisi cumque voluptas. fuga optio aut saepe voluptas adipisci temporibus ducimus omnis explicabo consequuntur!
